...
const Button = ({ children, href, variant = 'primary', className = '', ...props }) => {
  ...
  const variants = {
    primary: "bg-purple text-white hover:bg-white hover:text-black shadow-md hover:shadow-lg focus:ring-purple",
    secondary: "bg-skyBlue text-white hover:bg-white hover:text-black shadow-md hover:shadow-lg focus:ring-skyBlue",
